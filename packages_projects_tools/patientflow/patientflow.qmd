...
pub-info:
  ...
  rationale-for-status: |
    This work currently describes itself as an alpha release. It has been used by UCLH and a hospital in Sweden, but it is not in widespread use beyond that, so may still require modification for your own use case.
  entry-author:
    - name: Sammi Rosser
