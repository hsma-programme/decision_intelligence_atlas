---
title: "Sharing Tools and Artefacts for Reusable Simulation (STARS) Discrete Event Simulation Reusability Examples"
categories:
  - Pathway Analytics
tool-language:
  - Python
...
pub-info:
  ...
  rationale-for-status: |
    Scripts and packages with limited documentation, tests and maintenance.
  abstract: |
