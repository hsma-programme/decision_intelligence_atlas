...
pub-info:
  ...
  rationale-for-status: |
    This resource guides users in building "Gold" standard models - well-documented, tested, and structured as packages - with four complete examples illustrating these best practices.
  entry-author:
    - name: Amy Heather
...
listing:
  - id: examples
    contents:
      - "../des_rap_mms/des_rap_mms.qmd"
      - "../des_rap_stroke/des_rap_stroke.qmd"
---
