...
image: nowcasts.png
author:
  - name: Richard Wood (R implementation)
    affiliation: Bristol, North Somerset and South Gloucestershire ICB
    orcid: 0000-0002-3476-395X
  - name: Sammi Rosser (PowerBI implementation)
    affiliation: Health Service Modelling Associates Programme (HSMA), NIHR PenArc, University of Exeter (Devon Partnership Trust at time of work)
...
pub-info:
  ...
  rationale-for-status: |
    Useful script for short-term operational forecasting. As it is a single script, and does not have documentation, tests or extra features, this has been rated as "Bronze".
  entry-author:
    - name: Sammi Rosser
      url: https://github.com/Bergam0t
  abstract: |
  ...
  - name: Code - PowerBI Visual
    url: https://github.com/Bergam0t/nowcasts-power-bi
    icon: fa-brands fa-github
  - name: Documentation
    url:
